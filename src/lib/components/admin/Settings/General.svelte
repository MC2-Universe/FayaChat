					...
					<div class="mb-2.5">
						<div class="mt-1">
							<div class="flex space-x-1">
								...
								<a href="https://twitter.com/MC2Universe" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/MC2Universe"
									/>
								</a>

								<a href="https://github.com/MC2-Universe/FayaChat" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/MC2-Universe/FayaChat?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
